...
se <- clusterBanksy(se, use_agf = T, lambda = lambda, resolution = c(0.3, 0.5))
...
plot_lam08res1 <- plotColData(se,
    x = "x", y = "y",
    point_size = 0.6, colour_by = cnames[4]
)
plot_lam02res03 <- plotColData(se,
    x = 'x', y = 'y',
    point_size = 0.6, colour_by = cnames[5]
)
plot_lam02res05 <- plotColData(se,
    x = "x", y = "y",
    point_size = 0.6, colour_by = cnames[6]
)
plot_lam08res03 <- plotColData(se,
    x = "x", y = "y",
    point_size = 0.6, colour_by = cnames[7]
)
plot_lam08res05 <- plotColData(se,
    x = "x", y = "y",
    point_size = 0.6, colour_by = cnames[8]
)
